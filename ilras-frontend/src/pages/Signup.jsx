...
const Signup = ({ onLogin }) => {
    ...
    useEffect(() => {
        ...
        if (code) {
            ...
            const authenticateGithub = async () => {
                try {
                    const res = await axios.post(`${import.meta.env.VITE_API_URL}/auth/github-login`, {
                        code,
                        role: pendingRole
                    });
                    ...
                    if (error.response?.data?.message) {
                        ...
                        setErrorMsg('GitHub Registration failed. Please verify your credentials.');
                    }
                }
            };
    ...
    return (
        ...
        .animate-3d-spin {
          animation: slow-spin-3d 10s linear infinite;
        }
      ...
      `}</style>
            ...
            <div className="hidden lg:flex flex-col justify-center items-center w-1/2 relative bg-gradient-to-br from-blue-900 via-[#0a0f25] to-[#0d0f1a] p-12">
                ...
                <div className="relative z-10 flex flex-col items-center justify-center w-full max-w-2xl perspective-container">
                    <div className="inline-block bg-white/5 p-10 rounded-[3rem] backdrop-blur-md border border-white/10 shadow-2xl mb-10 transition-transform duration-500 hover:scale-105">
                        <img src={bitLogo} alt="Bannari Amman Institute of Technology" className="w-[400px] object-contain opacity-95 drop-shadow-2xl animate-3d-spin" />
                    </div>
                    <div className="text-center">
                        <h1 className="text-5xl font-extrabold mb-4 tracking-tight">
                            Create an <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#3b82f6] to-[#0ea5e9]">Account</span>
                        </h1>
            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-[#11131a] relative z-20 overflow-y-auto">
                <div className="w-full max-w-md bg-[#161821] p-8 md:p-10 rounded-3xl border border-gray-800 shadow-2xl">

                    <div className="flex flex-col items-center mb-6">
                        <div className="w-14 h-14 bg-gradient-to-tr from-blue-500 to-cyan-500 rounded-2xl flex items-center justify-center mb-6 shadow-[0_0_30px_rgba(59,130,246,0.4)]">
                        ...
                        <h2 className="text-3xl font-bold text-white mb-2 tracking-tight">Sign Up</h2>
                        <p className="text-gray-400 text-sm">Join the LRAS Platform</p>
                    </div>
                    ...
                    <form onSubmit={handleRegister} className="space-y-4">
                        <div>
                            ...
                            <div className="relative">
                                <select className="w-full px-4 py-3 bg-[#1e2029] border border-gray-700 rounded-xl text-white appearance-none focus:outline-none focus:ring-2 focus:ring-blue-500/50 transition-all cursor-pointer" value={role} onChange={(e) => setRole(e.target.value)}>
                        ...
                        <div>
                            ...
                            <div className="relative">
                                <input type="text" required placeholder="John Doe" value={name} onChange={(e) => setName(e.target.value)} className="w-full pl-4 pr-4 py-3 bg-[#1e2029] border border-gray-700 rounded-xl text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500/50 transition-all" />
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div className="relative">
                                <input type="email" required placeholder="john@example.com" value={email} onChange={(e) => setEmail(e.target.value)} className="w-full pl-4 pr-4 py-3 bg-[#1e2029] border border-gray-700 rounded-xl text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500/50 transition-all" />
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div className="relative">
                                <input type={showPassword ? "text" : "password"} required placeholder="Create a strong password" value={password} onChange={(e) => setPassword(e.target.value)} className="w-full pl-4 pr-11 py-3 bg-[#1e2029] border border-gray-700 rounded-xl text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500/50 transition-all" />
                        ...
                        <button type="submit" className="w-full mt-2 py-3.5 bg-gradient-to-r from-[#0ea5e9] to-[#3b82f6] hover:from-[#0284c7] hover:to-[#2563eb] text-white font-bold rounded-xl transition-all shadow-lg hover:shadow-blue-500/20 active:scale-[0.98]">
                            Create Account
                        </button>
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <button type="button" className="flex items-center justify-center space-x-2 py-3 border border-gray-700 rounded-xl hover:bg-gray-800 transition-colors group">
                        ...
                        <div className="text-center pt-2">
                            <span className="text-gray-400 text-sm">Already have an account? <Link to="/login" className="text-blue-400 hover:text-blue-300 font-semibold transition-colors">Sign In</Link></span>
                        </div>
